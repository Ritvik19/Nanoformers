...
from src.training.self_supervised_learning.causal_language_modeling.dataset import (
    CLMDataset,
    group_texts,
    tokenize_function,
)
from src.training.self_supervised_learning.causal_language_modeling.loss import (
    forward_loss,
)
...
def train(args, model, tokenizer, train_loader, eval_loader, optimizer, scaler, scheduler):
    ...
    # Per-optimizer-step accumulator so logged scalars describe the effective
    # batch (= ga micro-batches), not just the last micro-batch.

...
from src.training.common.io import (
    ...
    load_image_text_contrastive_processor,
)
...
def load_processor_only(args):
    ...
    processor = load_image_text_contrastive_processor(args["model_path"])
...
def load_model(args):
    print("Loading model...")
    model = load_image_text_contrastive_model(args["model_path"], args["device"])
    print("Model loaded...")
    return model
